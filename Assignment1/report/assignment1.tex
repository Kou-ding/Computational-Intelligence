...
\begin{itemize}
    \item \textbf{1η Περίπτωση:} $\Delta e(k)>5$. Όταν η διαφορά του σφάλματος είναι μεγαλύτερη από 5, δηλαδή θεωρείται θετική, τότε το σύστημα εφαρμόζει ισχυρή θετική διόρθωση για να αντισταθμίσει την ταχεία αύξηση του σφάλματος.
    \item \textbf{2η Περίπτωση:} $\Delta e(k)<5$. Όταν η διαφορά του σφάλματος είναι μεγαλύτερη από 5, δηλαδή θεωρείται θετική, τότε το σύστημα εφαρμόζει μέτρια ή μικρή αρνητική διόρθωση για να αποφευχθεί η έντονη υπερύψωση καθώς το σφάλμα μειώνεται.
    \item \textbf{3η Περίπτωση:} $\Delta e(k)=5$. Όταν η διαφορά του σφάλματος δεν σημειώνει κάποια μεταβολή, δηλαδή θεωρείται μηδέν, τότε το σύστημα ασκεί μια διόρθωση αντίθετη του τρέχοντος σφάλματος, ώστε να το οδηγήσει στο μηδέν.  
\end{itemize}

\subsection{Σενάριο 1}
\subsubsection{Α. Σχεδίαση του ελεγκτη και αποκρίσεις}
Για την εύρεση των βέλτιστων κερδών που ικανοποιεί τους περιορισμούς μου, $t_{rise}<0.6s$, $Overshoot<5\%$ χρησιμοποιήθηκε μια ελαφρώς τροποποιημένη έκδοση του fuzzy controller (\textbf{optimal_gains_finder.m}) η οποία τρέχει σε μία τριπλή for loop διάφορες τιμές των κερδών $K_1$, $K_e$ και $K_d$. Το αποτέλεσμα αυτής φαίνεται στους Πίνακες \ref{tab:gains1}, \ref{tab:gains2} από τους οποίους επιλέχθηκαν οι τιμές $K1=80$,$Ke=0.001$, $Kd=0.0002$.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/controller_step_response.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/sig0_response.png}
...
\begin{figure}[H]
    ...
    \label{fig:fis_io}
\end{figure}
Παρατηρούμε πως η επιφάνεια που δημιουργείται έχει την γενική τάση όταν οι δύο είσοδοι είναι μεγάλες (θετικές ή αρνητικές) να οδηγούν την έξοδο να είναι επίσης μεγάλη (θετική ή αρνητική). Στις δύο περιοχές που σημειώνονται τα κοίλα προς τα πάνω και προς τα κάτω,  
